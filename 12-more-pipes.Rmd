...
```{r echo = FALSE, fig.cap= "Histogram of scores for female participants"}
AQ_all %>%
...
* Which group has the lowest median total AQ score? `r mcq(c(answer = "female", "male", "nonbinary"))`
* Which group has an outlier? `r mcq(c("female", answer = "male", "nonbinary"))`
* Which of the following do you think would be an accurate conclusion to draw from the plot? `r mcq(c("Women had higher AQ scores than men or nonbinary people", answer = "Men and nonbinary people's scores did not differ much and both had higher AQ scores than wome", "Men had higher AQ scores than nonbinary people who had higher scores than women"))`
...
```{r fig.cap = "Bad bar chart of means"}
AQ_all %>%
...
```{r fig.cap= "Grouped density plot"}
...
* Approximately what percent of female participants had a total AQ of 2? `r mcq(c(".3%", "3%", answer = "30%"))`
